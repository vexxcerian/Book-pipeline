...
The middle third's pacing collapses — three days pass in two sentences. <!-- finding: F-RR-01 -->

The opening scene states the want but never shows a cost. <!-- finding: F-LR-01 -->

The chapter's POV discipline wavers in one paragraph. <!-- finding: F-NEG-01 -->

The orientation read flags a soft genre signal with no single locus. <!-- finding: F-DOC-01 -->

The unlit-lighthouse reveal lands as a stated fact rather than a felt beat. <!-- finding: F-QT-01 -->

The repeated phrase reads as an unearned refrain. <!-- finding: F-QAMB-01 -->
