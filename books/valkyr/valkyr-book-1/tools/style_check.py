...
PIPELINE_FLOORS = {
    # The author runs 2.0-4.2 true comparisons/1k. Every pipeline chapter came in at
    # 0.3-1.3 — below his floor, all three, while passing a ceiling of 5.0 easily.
    # The ceiling existed and the floor did not, which is the same asymmetry the
    # em-dash had: a gate that can only catch the pipeline OVERSHOOTING the author
    # cannot see it writing plainer than he does. Set at his measured minimum.
    "simile_per1k": 2.0,
    "emdash_per1k": 8.5,
    "comma_per1k": 58.0,
...
DIALECT = "us"  # the author's Ch.1-5: 82 US forms, zero British
